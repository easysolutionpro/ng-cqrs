...
import { CQRS_MODULE_REGISTRY, CqrsModuleOptions } from './interfaces/module-options';
...
export class CqrsLoader
{
  ...
  )
  {
    ...
    {
      this.handlersToLoad.set(getActionTypeFromInstance(route.impl), route.handler);
    });
  }
